...
class Bird {
    constructor(game) {
        ...
        this.animate2 = new Animator(this.spritesheet, 8, 432, 115, 115, 4, 0.2, 0, false, true);
        this.animate3 = new Animator(this.spritesheet, 0, 95, 115, 115, 4, 0.15, 0, false, true);
    ...
    draw(ctx) {
        ...
        this.animate3.drawFrame(this.game.clockTick, ctx, this.x3, this.y3, 1);
    }
